        ...
        <div class="table-wrapper">
            <table>
                ...
                <tr>
                    ...
                    <th class="qty"><div>ubicacion</div></th>
                    <th class="unit"><div>descripcion</div></th>
                </tr>
                </tbody>
                <tbody class="body">
                @foreach ($items as $empresa)
                    <tr>
                        <td>{{$empresa->id}}</td>
                        <td>{{$empresa->nombre}}</td>
                        <td>{{$empresa->direccion}}</td>
                        <td><img src="imagenes/empresa/{{$empresa->logo}}" height="80px" width="80px"
